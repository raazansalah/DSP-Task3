...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comp1_box2.setItemText(0, _translate("MainWindow", "Choose  "))
        self.comp1_box2.setItemText(1, _translate("MainWindow", "Magnitude "))
        self.comp1_box2.setItemText(2, _translate("MainWindow", "Phase"))
        self.comp1_box2.setItemText(3, _translate("MainWindow", "Real"))
        self.comp1_box2.setItemText(4, _translate("MainWindow", "Imaginary"))
        self.comp1_box2.setItemText(5, _translate("MainWindow", "UniMagnitude"))
        self.comp1_box2.setItemText(6, _translate("MainWindow", "UniPhase"))
        self.comp1_box1.setItemText(0, _translate("MainWindow", "Image 1"))
        self.comp1_box1.setItemText(1, _translate("MainWindow", "Image 2"))
        self.mixer_box.setItemText(0, _translate("MainWindow", "Choose Output"))
        self.mixer_box.setItemText(1, _translate("MainWindow", "Output 1"))
        self.mixer_box.setItemText(2, _translate("MainWindow", "Output 2"))
